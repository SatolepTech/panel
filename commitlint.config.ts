    ...
    "questions": {
      "type": {
        ...
        "enum": {
          ...
          "style": {
            "description": "Alterações que não afetam o significado do código (espaços em branco, formatação, ponto e vírgula ausente, etc)",
            "title": "Estilos",
            "emoji": "💎"
          },
          "refactor": {
            "description": "Uma alteração no código que não corrige um bug nem adiciona uma funcionalidade",
            "title": "Refatoração de Código",
            "emoji": "📦"
          },
          "perf": {
            "description": "Uma alteração no código que melhora o desempenho",
          ...
          "build": {
            "description": "Alterações que afetam o sistema de build ou dependências externas (exemplos: gulp, broccoli, npm)",
            "title": "Builds",
            "emoji": "🛠"
          },
          "ci": {
            "description": "Alterações nos arquivos e scripts de configuração de CI (exemplos: Travis, Circle, BrowserStack, SauceLabs)",
            "title": "Integrações Contínuas",
            "emoji": "⚙️"
          },
          "chore": {
            "description": "Outras alterações que não modificam arquivos de código ou teste",
            "title": "Tarefas",
            "emoji": "♻️"
          },
          "revert": {
      ...
      "breakingBody": {
        "description": "Um commit com BREAKING CHANGE exige uma descrição detalhada. Insira uma descrição mais longa do próprio commit"
      },
      "breaking": {
      ...
      "issuesBody": {
        "description": "Se problemas forem encerrados, o commit exige uma descrição detalhada. Insira uma descrição mais longa do próprio commit"
      },
      "issues": {
        "description": "Adicione referências de problemas (ex.: \"fix #123\", \"re #123\")."
      }
    }
  }
}
